const experiences = [
    ...
    },
    {
        ...
        details: "The Python and R Graph Gallery websites are references on data visualization. I worked as a freelancer alongside my studies on the development of these sites, with the main aim of making them as exhaustive as possible. I obviously used Python and R, but also a little HTML/React for the web part, and Git for versioning.",
    },
    {
        id: 3,
        title: 'Data Science Intern at Wanteeed',
        period: 'Apr 2023 - Aug 2023',
        details: "Wanteeed is a French start-up offering a free browser extension and mobile application that automatically applies discount codes and/or cashback offers to users. My job was to try and better understand the company's data, particularly from a marketing and financial point of view, as well as to make predictions. I mainly worked with SQL and Looker, but also used Python for more specific tasks.",
    },
    {
        id: 2,
        title: 'Tutoring teacher at the University of Bordeaux',
        period: 'Sep 2022 - Nov 2022',
        details: "I have tutored students in their second year of a Bachelor's degree in Economics and Management at the University of Bordeaux. The classes were on microeconomics and the main concepts derived from it, such as general equilibrium, utility optimization with or without constraints, and Walrasian equilibrium.",
    },
    {
        id: 1,
